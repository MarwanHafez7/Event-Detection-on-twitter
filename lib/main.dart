...
getListFromFirebase() async {
  print("Marwaan");
  // final database = FirebaseDatabase.instance.ref("results");
  // DatabaseEvent snapshot = await database.child("results").once();
  //
  // if (snapshot.snapshot.value != null) {
  //   // Convert the snapshot value to a List<dynamic>
  //   List<dynamic> list = [];
  //   // Map<dynamic, dynamic> map = snapshot.snapshot.value;
  //   // map.forEach((key, value) {
  //   //   list.add(value);
  //   // });
  //   print("Valluee   ${snapshot.snapshot.value}");
  //   return list;
  // } else {
  //   return [];
  // }
  ...
  databaseReference.child('results').once().then((val) {
    if (val.snapshot.value != null) {
      Map<dynamic, dynamic> values = Map<dynamic, dynamic>.from(
          val.snapshot.value as Map<dynamic, dynamic>);
...
void main() async {
  ...
  await Firebase.initializeApp();
  List x = await getListFromFirebase();
